...
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "EncryptedArmorTokenIsHashedUsingHMACSHA256", "In order to prove that an encrypted ArmorToken is hashed using HMACSHA256\r\nAs an " +
        ...
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Hash an encrypted ArmorToken using HMACSHA256", new string[] {
                        "armorTokenHasher"});
#line 7
