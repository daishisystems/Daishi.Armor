...
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "EncryptedArmorTokenIsHashedUsingHMACSHA512", "In order to prove that an encrypted ArmorToken is hashed using HMACSHA512\r\nAs an " +
        ...
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Hash an encrypted ArmorToken using HMACSHA512", new string[] {
                        "armorTokenHasher"});
#line 7
